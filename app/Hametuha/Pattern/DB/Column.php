...
class Column {
	...
	public static function exists( $type ) {
		...
		return false !== array_search( $type, $constants, true );
	}
	 ...
	 * @return bool
	 */
	protected static function is_length_required( $type ) {
		return false !== array_search( $type, [ self::VARCHAR, self::VARBINARY ], true );
	}
	 ...
	 * @return bool
	 */
	protected static function is_numeric( $type ) {
		switch ( $type ) {
			case self::INT:
			case self::TINYINT:
			case self::MEDIUMINT:
	 ...
	 * @return bool
	 */
	protected static function is_set( $type ) {
		return false !== array_search( $type, [ self::ENUM, self::SET ], true );
	}
	 ...
	 * @return string
	 */
	protected static function data_type( $column ) {
		/** @var $wpdb \wpdb */
		global $wpdb;
		// Let's create query
		$sql = $column['type'];
